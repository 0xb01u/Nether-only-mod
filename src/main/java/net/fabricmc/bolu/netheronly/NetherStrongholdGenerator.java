...
public class NetherStrongholdGenerator {
	...
	public static class PortalRoom extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ...
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 10, 7, 15, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.generateEntrance(structureWorldAccess, random, boundingBox,
					NetherStrongholdGenerator.Piece.EntranceType.GRATES, 4, 1, 0);
			int i = 6;
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, i, 1, 1, i, 14, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 9, i, 1, 9, i, 14, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 2, i, 1, 8, i, 2, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 2, i, 14, 8, i, 14, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 1, 1, 2, 1, 4, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 8, 1, 1, 9, 1, 4, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 1, 1, 1, 1, 3, Blocks.LAVA.getDefaultState(),
					Blocks.LAVA.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 9, 1, 1, 9, 1, 3, Blocks.LAVA.getDefaultState(),
					Blocks.LAVA.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 3, 1, 8, 7, 1, 12, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 9, 6, 1, 11, Blocks.LAVA.getDefaultState(),
					Blocks.LAVA.getDefaultState(), false);
			...
			for (k = 2; k < 9; k += 2) {
				this.fillWithOutline(structureWorldAccess, boundingBox, k, 3, 15, k, 4, 15, blockState2, blockState2,
						false);
			}

			BlockState blockState3 =
					Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 5, 6, 1, 7, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 2, 6, 6, 2, 7, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 3, 7, 6, 3, 7, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
	...
	public static class FiveWayCrossing extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos,
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 9, 8, 10, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			...
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 2, 1, 8, 2, 6, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 5, 4, 4, 9, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 8, 1, 5, 8, 4, 9, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 4, 7, 3, 4, 9, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 3, 5, 3, 3, 6, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 3, 4, 3, 3, 4,
					Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 4, 6, 3, 4, 6,
					Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 5, 1, 7, 7, 1, 8, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 5, 1, 9, 7, 1, 9,
					Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 5, 2, 7, 7, 2, 7,
					Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 5, 7, 4, 5, 9,
					Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 8, 5, 7, 8, 5, 9,
					Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 5, 5, 7, 7, 5, 9,
			...
			this.addBlock(structureWorldAccess,
	...
	public static class Library extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
			...
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 13, i - 1, 14, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.generateEntrance(structureWorldAccess, random, boundingBox, this.entryDoor, 4, 1, 0);
			this.fillWithOutlineUnderSeaLevel(structureWorldAccess, boundingBox, random, 0.07F, 2, 1, 1, 11, 4, 13,
					Blocks.COBWEB.getDefaultState(), Blocks.COBWEB.getDefaultState(), false, false);

			int l;
			for (l = 1; l <= 13; ++l) {
				if ((l - 1) % 4 == 0) {
					this.fillWithOutline(structureWorldAccess, boundingBox, 1, 1, l, 1, 4, l,
							Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
					this.fillWithOutline(structureWorldAccess, boundingBox, 12, 1, l, 12, 4, l,
							Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
					this.addBlock(structureWorldAccess,
					...
					this.addBlock(structureWorldAccess,
							...
							l, boundingBox);
					if (this.tall) {
						this.fillWithOutline(structureWorldAccess, boundingBox, 1, 6, l, 1, 9, l,
								Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
						this.fillWithOutline(structureWorldAccess, boundingBox, 12, 6, l, 12, 9, l,
								Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
					}
				} else {
					this.fillWithOutline(structureWorldAccess, boundingBox, 1, 1, l, 1, 4, l,
			...
			for (l = 3; l < 12; l += 2) {
				this.fillWithOutline(structureWorldAccess, boundingBox, 3, 1, l, 4, 3, l,
						Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 6, 1, l, 7, 3, l,
						Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 9, 1, l, 10, 3, l,
						Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
			}

			if (this.tall) {
				this.fillWithOutline(structureWorldAccess, boundingBox, 1, 5, 1, 3, 5, 13,
						Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 10, 5, 1, 12, 5, 13,
						Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 4, 5, 1, 9, 5, 2,
						Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 4, 5, 12, 9, 5, 13,
						Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 9, 5, 11, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 8, 5, 11, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 9, 5, 10, boundingBox);
				...
				this.fillWithOutline(structureWorldAccess, boundingBox, 3, 6, 3, 3, 6, 11, blockState2, blockState2,
						false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 10, 6, 3, 10, 6, 9, blockState2, blockState2,
						false);
				...
				for (int n = 0; n <= 2; ++n) {
					this.addBlock(structureWorldAccess, (Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true))
				...
				this.addBlock(structureWorldAccess, blockState4.with(FenceBlock.NORTH, true), 6, 7, 6, boundingBox);
				this.addBlock(structureWorldAccess, blockState4.with(FenceBlock.SOUTH, true), 6, 7, 8, boundingBox);
				this.addBlock(structureWorldAccess, blockState5.with(FenceBlock.NORTH, true), 7, 7, 6, boundingBox);
				this.addBlock(structureWorldAccess, blockState5.with(FenceBlock.SOUTH, true), 7, 7, 8, boundingBox);
	...
	public static class PrisonHall extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos,
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 8, 4, 10, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			...
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 1, 4, 3, 1, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 3, 4, 3, 3, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 7, 4, 3, 7, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 9, 4, 3, 9, false, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			...
			this.addBlock(structureWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.NORTH, true))
	...
	public static class SquareRoom extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos,
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 10, 6, 10, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.generateEntrance(structureWorldAccess, random, boundingBox, this.entryDoor, 4, 1, 0);
			...
			switch (this.roomType) {
				case 0:
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 5, 1, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 5, 2, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 5, 3, 5, boundingBox);
					this.addBlock(structureWorldAccess,
					...
					this.addBlock(structureWorldAccess,
							...
							6, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 4, 1, 4, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 4, 1, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 4, 1, 6, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 6, 1, 4, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 6, 1, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 6, 1, 6, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 5, 1, 4, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 5, 1, 6, boundingBox);
					break;
				case 1:
					for (m = 0; m < 5; ++m) {
						this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 1, 3 + m,
								boundingBox);
						this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 7, 1, 3 + m,
								boundingBox);
						this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3 + m, 1, 3,
								boundingBox);
						this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3 + m, 1, 7,
								boundingBox);
					}
					...
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 5, 2, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 5, 3, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.LAVA.getDefaultState(), 5, 4, 5, boundingBox);
					break;
				case 2:
					for (m = 1; m <= 9; ++m) {
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 1, 3, m, boundingBox);
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 9, 3, m, boundingBox);
					}

					for (m = 1; m <= 9; ++m) {
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), m, 3, 1, boundingBox);
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), m, 3, 9, boundingBox);
					}

					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 5, 1, 4, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 5, 1, 6, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 5, 3, 4, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 5, 3, 6, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 4, 1, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 6, 1, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 4, 3, 5, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 6, 3, 5, boundingBox);

					for (m = 1; m <= 3; ++m) {
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 4, m, 4, boundingBox);
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 6, m, 4, boundingBox);
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 4, m, 6, boundingBox);
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 6, m, 6, boundingBox);
					}

					this.addBlock(structureWorldAccess, Blocks.SOUL_TORCH.getDefaultState(), 5, 3, 5, boundingBox);

					for (m = 2; m <= 8; ++m) {
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 2, 3, m, boundingBox);
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 3, 3, m, boundingBox);
						if (m <= 3 || m >= 7) {
							this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 4, 3, m, boundingBox);
							this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 5, 3, m, boundingBox);
							this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 6, 3, m, boundingBox);
						}

						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 7, 3, m, boundingBox);
						this.addBlock(structureWorldAccess, Blocks.BLACKSTONE.getDefaultState(), 8, 3, m, boundingBox);
					}
					...
					this.addChest(structureWorldAccess, boundingBox, random, 3, 4, 8,
	...
	public static class RightTurn extends NetherStrongholdGenerator.Turn {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos,
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 4, 4, 4, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.generateEntrance(structureWorldAccess, random, boundingBox, this.entryDoor, 1, 1, 0);
			Direction direction = this.getFacing();
			if (direction != Direction.NORTH && direction != Direction.EAST) {
	...
	public static class Stairs extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos,
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 4, 10, 7, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			...
			for (int i = 0; i < 6; ++i) {
				...
				if (i < 5) {
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 5 - i, 1 + i,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 2, 5 - i, 1 + i,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 5 - i, 1 + i,
							boundingBox);
				}
			}
	...
	public static class ChestCorridor extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos,
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 4, 4, 6, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.generateEntrance(structureWorldAccess, random, boundingBox, this.entryDoor, 1, 1, 0);
			this.generateEntrance(structureWorldAccess, random, boundingBox,
					NetherStrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 6);
			this.fillWithOutline(structureWorldAccess, boundingBox, 3, 1, 2, 3, 1, 4,
					Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
			this.addBlock(structureWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 1, 1,
					boundingBox);
			this.addBlock(structureWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 1, 5,
					boundingBox);
			this.addBlock(structureWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 2, 2,
					boundingBox);
			this.addBlock(structureWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 2, 4,
					boundingBox);

			for (int i = 2; i <= 4; ++i) {
				this.addBlock(structureWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 2, 1, i,
						boundingBox);
			}
	...
	public static class SpiralStaircase extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
		                        ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos,
		                        BlockPos blockPos) {
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 4, 10, 4, true, random,
					NetherStrongholdGenerator.BRICK_RANDOMIZER);
			this.generateEntrance(structureWorldAccess, random, boundingBox, this.entryDoor, 1, 7, 0);
			this.generateEntrance(structureWorldAccess, random, boundingBox,
					NetherStrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 4);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 2, 6, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 5, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 1, 6, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 5, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 4, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 1, 5, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 2, 4, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 3, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 3, 4, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 3, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 2, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 3, 3, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 2, 2, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 1, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 1, 2, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 1, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.NETHER_BRICK_SLAB.getDefaultState(), 1, 1, 3, boundingBox);
			return true;
		}
	}
	...
	public static class SmallCorridor extends NetherStrongholdGenerator.Piece {
		...
		public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor,
			...
			for (int i = 0; i < this.length; ++i) {
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 0, 0, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 0, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 2, 0, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 0, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 4, 0, i, boundingBox);

				for (int j = 1; j <= 3; ++j) {
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 0, j, i, boundingBox);
					...
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 4, j, i, boundingBox);
				}

				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 0, 4, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 4, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 2, 4, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 4, i, boundingBox);
				this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 4, 4, i, boundingBox);
			}
	...
	abstract static class Piece extends StructurePiece {
		...
		protected void generateEntrance(StructureWorldAccess structureWorldAccess, Random random, BlockBox boundingBox,
		                                NetherStrongholdGenerator.Piece.EntranceType type, int x, int y, int z) {
			switch (type) {
				case OPENING:
					this.fillWithOutline(structureWorldAccess, boundingBox, x, y, z, x + 3 - 1, y + 3 - 1, z, AIR, AIR,
							false);
					break;
				case WOOD_DOOR:
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x, y, z, boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x, y + 1, z,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x, y + 2, z,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x + 1, y + 2, z,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x + 2, y + 2, z,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x + 2, y + 1, z,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x + 2, y, z,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.CRIMSON_DOOR.getDefaultState(), x + 1, y, z,
							boundingBox);
					this.addBlock(structureWorldAccess,
				...
				case GRATES:
					...
					this.addBlock(structureWorldAccess, Blocks.CAVE_AIR.getDefaultState(), x + 1, y + 1, z,
							boundingBox);
					this.addBlock(structureWorldAccess,
							Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true), x, y,
							z, boundingBox);
					this.addBlock(structureWorldAccess,
							Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true), x,
							y + 1, z, boundingBox);
					this.addBlock(structureWorldAccess,
							(Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true))
					...
					this.addBlock(structureWorldAccess,
							Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true), x + 2,
							y + 1, z, boundingBox);
					this.addBlock(structureWorldAccess,
							Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true), x + 2,
							y, z, boundingBox);
				...
				case IRON_DOOR:
					...
					this.addBlock(structureWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), x + 2, y, z,
							boundingBox);
					this.addBlock(structureWorldAccess, Blocks.WARPED_DOOR.getDefaultState(), x + 1, y, z, boundingBox);
					this.addBlock(structureWorldAccess,
