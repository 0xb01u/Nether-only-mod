...
public class NetherStrongholdGenerator {
	public static final StructurePieceType NETHER_STRONGHOLD_CHEST_CORRIDOR = Registry.register(Registry.STRUCTURE_PIECE, "NSHCC".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.ChestCorridor::new);
	public static final StructurePieceType NETHER_STRONGHOLD_SMALL_CORRIDOR = Registry.register(Registry.STRUCTURE_PIECE, "NSHFC".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.SmallCorridor::new);
	public static final StructurePieceType NETHER_STRONGHOLD_FIVE_WAY_CROSSING = Registry.register(Registry.STRUCTURE_PIECE, "NSH5C".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.FiveWayCrossing::new);
	public static final StructurePieceType NETHER_STRONGHOLD_LEFT_TURN = Registry.register(Registry.STRUCTURE_PIECE, "NSHLT".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.LeftTurn::new);
	public static final StructurePieceType NETHER_STRONGHOLD_LIBRARY = Registry.register(Registry.STRUCTURE_PIECE, "NSHLi".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.Library::new);
	public static final StructurePieceType NETHER_STRONGHOLD_PORTAL_ROOM = Registry.register(Registry.STRUCTURE_PIECE, "NSHPR".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.PortalRoom::new);
	public static final StructurePieceType NETHER_STRONGHOLD_PRISON_HALL = Registry.register(Registry.STRUCTURE_PIECE, "NSHPH".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.PrisonHall::new);
	public static final StructurePieceType NETHER_STRONGHOLD_RIGHT_TURN = Registry.register(Registry.STRUCTURE_PIECE, "NSHRT".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.RightTurn::new);
	public static final StructurePieceType NETHER_STRONGHOLD_SQUARE_ROOM = Registry.register(Registry.STRUCTURE_PIECE, "NSHRC".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.SquareRoom::new);
	public static final StructurePieceType NETHER_STRONGHOLD_SPIRAL_STAIRCASE = Registry.register(Registry.STRUCTURE_PIECE, "NSHSD".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.SpiralStaircase::new);
	public static final StructurePieceType NETHER_STRONGHOLD_START = Registry.register(Registry.STRUCTURE_PIECE, "NSHStart".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.Start::new);
	public static final StructurePieceType NETHER_STRONGHOLD_CORRIDOR = Registry.register(Registry.STRUCTURE_PIECE, "NSHS".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.Corridor::new);
	public static final StructurePieceType NETHER_STRONGHOLD_STAIRS = Registry.register(Registry.STRUCTURE_PIECE, "NSHSSD".toLowerCase(Locale.ROOT), NetherStrongholdGenerator.Stairs::new);

	private NetherStrongholdGenerator() {
	}

	private static final NetherStrongholdGenerator.PieceSetting[] ALL_PIECE_SETTINGS = new NetherStrongholdGenerator.PieceSetting[]{new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.Corridor.class, 40, 0), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.PrisonHall.class, 5, 5), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.LeftTurn.class, 20, 0), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.RightTurn.class, 20, 0), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.SquareRoom.class, 10, 6), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.Stairs.class, 5, 5), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.SpiralStaircase.class, 5, 5), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.FiveWayCrossing.class, 5, 4), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.ChestCorridor.class, 5, 4), new NetherStrongholdGenerator.PieceSetting(NetherStrongholdGenerator.Library.class, 10, 2) {
		@Override
	...
	private static final NetherStrongholdGenerator.StoneBrickRandomizer STONE_BRICK_RANDOMIZER = new NetherStrongholdGenerator.StoneBrickRandomizer();
	...
	private static boolean method_14852() {
		...
		for (Iterator var1 = possiblePieceSettings.iterator(); var1.hasNext(); field_15264 += pieceSetting.field_15278) {
	...
	private static NetherStrongholdGenerator.Piece method_14847(Class<? extends NetherStrongholdGenerator.Piece> class_, List<StructurePiece> list, Random random, int i, int j, int k, @Nullable Direction direction, int l) {
	...
	private static NetherStrongholdGenerator.Piece method_14851(NetherStrongholdGenerator.Start start, List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
		if (!method_14852()) {
			return null;
		} else {
			if (activePieceType != null) {
				NetherStrongholdGenerator.Piece piece = method_14847(activePieceType, list, random, i, j, k, direction, l);
				activePieceType = null;
				if (piece != null) {
					return piece;
				}
			...
			while (m < 5) {
				...
				for (PieceSetting pieceSetting : possiblePieceSettings) {
					...
					if (n < 0) {
						...
						Piece piece2 = method_14847(pieceSetting.pieceType, list, random, i, j, k, direction, l);
						if (piece2 != null) {
			...
			BlockBox blockBox = NetherStrongholdGenerator.SmallCorridor.method_14857(list, random, i, j, k, direction);
	...
	private static StructurePiece method_14854(NetherStrongholdGenerator.Start start, List<StructurePiece> list, Random random, int i, int j, int k, @Nullable Direction direction, int l) {
		if (l > 50) {
			return null;
	...
	public static class PortalRoom extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.PortalRoom method_14863(List<StructurePiece> list, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -4, -1, 0, 11, 8, 16, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.PortalRoom(l, blockBox, direction) : null;
		}
		...
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 10, 7, 15, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.generateEntrance(serverWorldAccess, random, boundingBox, NetherStrongholdGenerator.Piece.EntranceType.GRATES, 4, 1, 0);
			int i = 6;
			this.fillWithOutline(serverWorldAccess, boundingBox, 1, i, 1, 1, i, 14, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 9, i, 1, 9, i, 14, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 2, i, 1, 8, i, 2, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 2, i, 14, 8, i, 14, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 1, 1, 1, 2, 1, 4, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 8, 1, 1, 9, 1, 4, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			...
			this.fillWithOutline(serverWorldAccess, boundingBox, 3, 1, 8, 7, 1, 12, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			...
			BlockState blockState = (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true);
			BlockState blockState2 = (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true);
			...
			for (k = 2; k < 9; k += 2) {
				this.fillWithOutline(serverWorldAccess, boundingBox, k, 3, 15, k, 4, 15, blockState2, blockState2, false);
			}

			BlockState blockState3 = Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 1, 5, 6, 1, 7, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 2, 6, 6, 2, 7, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 3, 7, 6, 3, 7, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
	...
	public static class FiveWayCrossing extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.FiveWayCrossing method_14858(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -4, -3, 0, 10, 9, 11, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.FiveWayCrossing(l, random, blockBox, direction) : null;
		}

		@Override
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 9, 8, 10, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			...
			this.fillWithOutline(serverWorldAccess, boundingBox, 1, 2, 1, 8, 2, 6, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 1, 5, 4, 4, 9, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 8, 1, 5, 8, 4, 9, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 1, 4, 7, 3, 4, 9, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 1, 3, 5, 3, 3, 6, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 1, 3, 4, 3, 3, 4, Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(serverWorldAccess, boundingBox, 1, 4, 6, 3, 4, 6, Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(serverWorldAccess, boundingBox, 5, 1, 7, 7, 1, 8, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 5, 1, 9, 7, 1, 9, Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(serverWorldAccess, boundingBox, 5, 2, 7, 7, 2, 7, Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 5, 7, 4, 5, 9, Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(serverWorldAccess, boundingBox, 8, 5, 7, 8, 5, 9, Blocks.NETHER_BRICK_SLAB.getDefaultState(), Blocks.NETHER_BRICK_SLAB.getDefaultState(), false);
			this.fillWithOutline(serverWorldAccess, boundingBox, 5, 5, 7, 7, 5, 9, Blocks.NETHER_BRICK_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), Blocks.NETHER_BRICK_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), false);
			this.addBlock(serverWorldAccess, Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.SOUTH), 6, 5, 6, boundingBox);
			return true;
		}
	}
	...
	public static class Library extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.Library method_14860(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
		...
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			...
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 13, i - 1, 14, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			...
			for (l = 1; l <= 13; ++l) {
				if ((l - 1) % 4 == 0) {
					this.fillWithOutline(serverWorldAccess, boundingBox, 1, 1, l, 1, 4, l, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
					this.fillWithOutline(serverWorldAccess, boundingBox, 12, 1, l, 12, 4, l, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
					this.addBlock(serverWorldAccess, Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 2, 3, l, boundingBox);
					this.addBlock(serverWorldAccess, Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 11, 3, l, boundingBox);
					if (this.tall) {
						this.fillWithOutline(serverWorldAccess, boundingBox, 1, 6, l, 1, 9, l, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
						this.fillWithOutline(serverWorldAccess, boundingBox, 12, 6, l, 12, 9, l, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
					}
				} else {
			...
			if (this.tall) {
				this.fillWithOutline(serverWorldAccess, boundingBox, 1, 5, 1, 3, 5, 13, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				this.fillWithOutline(serverWorldAccess, boundingBox, 10, 5, 1, 12, 5, 13, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				this.fillWithOutline(serverWorldAccess, boundingBox, 4, 5, 1, 9, 5, 2, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				this.fillWithOutline(serverWorldAccess, boundingBox, 4, 5, 12, 9, 5, 13, Blocks.BLACKSTONE.getDefaultState(), Blocks.BLACKSTONE.getDefaultState(), false);
				...
				this.addBlock(serverWorldAccess, (Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 3, 6, 2, boundingBox);
				this.addBlock(serverWorldAccess, (Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.EAST, true), 3, 6, 12, boundingBox);
				this.addBlock(serverWorldAccess, (Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.WEST, true), 10, 6, 2, boundingBox);

				for (int n = 0; n <= 2; ++n) {
					this.addBlock(serverWorldAccess, (Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.WEST, true), 8 + n, 6, 12 - n, boundingBox);
					if (n != 2) {
						this.addBlock(serverWorldAccess, (Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 8 + n, 6, 11 - n, boundingBox);
					}
				}
	...
	public static class PrisonHall extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.PrisonHall method_14864(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -1, 0, 9, 5, 11, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.PrisonHall(l, random, blockBox, direction) : null;
		}

		@Override
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 8, 4, 10, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			...
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 1, 1, 4, 3, 1, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 1, 3, 4, 3, 3, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 1, 7, 4, 3, 7, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.fillWithOutline(serverWorldAccess, boundingBox, 4, 1, 9, 4, 3, 9, false, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);

			for (int i = 1; i <= 3; ++i) {
				this.addBlock(serverWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, i, 4, boundingBox);
				this.addBlock(serverWorldAccess, ((Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true)).with(PaneBlock.EAST, true), 4, i, 5, boundingBox);
				this.addBlock(serverWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, i, 6, boundingBox);
				this.addBlock(serverWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 5, i, 5, boundingBox);
				this.addBlock(serverWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 6, i, 5, boundingBox);
				this.addBlock(serverWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 7, i, 5, boundingBox);
			}

			this.addBlock(serverWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 2, boundingBox);
			this.addBlock(serverWorldAccess, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 8, boundingBox);
			BlockState blockState = Blocks.WARPED_DOOR.getDefaultState().with(DoorBlock.FACING, Direction.WEST);
			BlockState blockState2 = (Blocks.WARPED_DOOR.getDefaultState().with(DoorBlock.FACING, Direction.WEST)).with(DoorBlock.HALF, DoubleBlockHalf.UPPER);
	...
	public static class SquareRoom extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.SquareRoom method_14865(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -4, -1, 0, 11, 7, 11, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.SquareRoom(l, random, blockBox, direction) : null;
		}

		@Override
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 10, 6, 10, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.generateEntrance(serverWorldAccess, random, boundingBox, this.entryDoor, 4, 1, 0);
			...
			switch (this.roomType) {
				case 0:
					...
					this.addBlock(serverWorldAccess, Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 4, 3, 5, boundingBox);
					this.addBlock(serverWorldAccess, Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 6, 3, 5, boundingBox);
					this.addBlock(serverWorldAccess, Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.SOUTH), 5, 3, 4, boundingBox);
					this.addBlock(serverWorldAccess, Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.NORTH), 5, 3, 6, boundingBox);
				...
				case 1:
					for (m = 0; m < 5; ++m) {
						this.addBlock(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 1, 3 + m, boundingBox);
						this.addBlock(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 7, 1, 3 + m, boundingBox);
						this.addBlock(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3 + m, 1, 3, boundingBox);
						this.addBlock(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3 + m, 1, 7, boundingBox);
					}
	...
	public static class RightTurn extends NetherStrongholdGenerator.Turn {
		...
		public static NetherStrongholdGenerator.RightTurn method_16652(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -1, 0, 5, 5, 5, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.RightTurn(l, random, blockBox, direction) : null;
		}

		@Override
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 4, 4, 4, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.generateEntrance(serverWorldAccess, random, boundingBox, this.entryDoor, 1, 1, 0);
			Direction direction = this.getFacing();
			if (direction != Direction.NORTH && direction != Direction.EAST) {
	...
	public static class LeftTurn extends NetherStrongholdGenerator.Turn {
		...
		public static NetherStrongholdGenerator.LeftTurn method_14859(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -1, 0, 5, 5, 5, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.LeftTurn(l, random, blockBox, direction) : null;
		}
	...
	public static class Stairs extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.Stairs method_14868(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -7, 0, 5, 11, 8, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.Stairs(l, random, blockBox, direction) : null;
		}

		@Override
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 4, 10, 7, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.generateEntrance(serverWorldAccess, random, boundingBox, this.entryDoor, 1, 7, 0);
			this.generateEntrance(serverWorldAccess, random, boundingBox, NetherStrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 7);
			BlockState blockState = Blocks.BLACKSTONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.SOUTH);
			...
			for (int i = 0; i < 6; ++i) {
				...
				if (i < 5) {
					this.addBlock(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 1, 5 - i, 1 + i, boundingBox);
					this.addBlock(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 2, 5 - i, 1 + i, boundingBox);
					this.addBlock(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 3, 5 - i, 1 + i, boundingBox);
				}
			}
	...
	public static class ChestCorridor extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.ChestCorridor method_14856(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -1, 0, 5, 5, 7, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.ChestCorridor(l, random, blockBox, direction) : null;
		}

		@Override
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 4, 4, 6, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.generateEntrance(serverWorldAccess, random, boundingBox, this.entryDoor, 1, 1, 0);
			this.generateEntrance(serverWorldAccess, random, boundingBox, NetherStrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 6);
			this.fillWithOutline(serverWorldAccess, boundingBox, 3, 1, 2, 3, 1, 4, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
			this.addBlock(serverWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 1, 1, boundingBox);
			this.addBlock(serverWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 1, 5, boundingBox);
			this.addBlock(serverWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 2, 2, boundingBox);
			this.addBlock(serverWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 3, 2, 4, boundingBox);

			for (int i = 2; i <= 4; ++i) {
				this.addBlock(serverWorldAccess, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB.getDefaultState(), 2, 1, i, boundingBox);
			}
	...
	public static class Corridor extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.Corridor method_14867(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -1, 0, 5, 5, 7, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.Corridor(l, random, blockBox, direction) : null;
		}
		...
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			...
			this.generateEntrance(serverWorldAccess, random, boundingBox, this.entryDoor, 1, 1, 0);
			this.generateEntrance(serverWorldAccess, random, boundingBox, NetherStrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 6);
			BlockState blockState = Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST);
			BlockState blockState2 = Blocks.SOUL_WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST);
	...
	public static class SpiralStaircase extends NetherStrongholdGenerator.Piece {
		...
		public static NetherStrongholdGenerator.SpiralStaircase method_14866(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
			BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -7, 0, 5, 11, 5, direction);
			return method_14871(blockBox) && StructurePiece.getOverlappingPiece(list, blockBox) == null ? new NetherStrongholdGenerator.SpiralStaircase(l, random, blockBox, direction) : null;
		}

		@Override
		public boolean generate(ServerWorldAccess serverWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
			this.fillWithOutline(serverWorldAccess, boundingBox, 0, 0, 0, 4, 10, 4, true, random, NetherStrongholdGenerator.STONE_BRICK_RANDOMIZER);
			this.generateEntrance(serverWorldAccess, random, boundingBox, this.entryDoor, 1, 7, 0);
			this.generateEntrance(serverWorldAccess, random, boundingBox, NetherStrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 4);
	...
	abstract static class Piece extends StructurePiece {
		...
		protected void generateEntrance(WorldAccess world, Random random, BlockBox boundingBox, NetherStrongholdGenerator.Piece.EntranceType type, int x, int y, int z) {
			switch (type) {
				case OPENING:
				...
				case WOOD_DOOR:
					...
					this.addBlock(world, Blocks.CRIMSON_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), x + 1, y + 1, z, boundingBox);
					break;
				case GRATES:
					...
					this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true), x, y, z, boundingBox);
					this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.WEST, true), x, y + 1, z, boundingBox);
					this.addBlock(world, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), x, y + 2, z, boundingBox);
					this.addBlock(world, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), x + 1, y + 2, z, boundingBox);
					this.addBlock(world, (Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), x + 2, y + 2, z, boundingBox);
					this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true), x + 2, y + 1, z, boundingBox);
					this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(PaneBlock.EAST, true), x + 2, y, z, boundingBox);
					break;
				case IRON_DOOR:
					this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), x, y, z, boundingBox);
					this.addBlock(world, Blocks.NETHER_BRICKS.getDefaultState(), x, y + 1, z, boundingBox);
					...
					this.addBlock(world, Blocks.WARPED_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), x + 1, y + 1, z, boundingBox);
					this.addBlock(world, Blocks.WARPED_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.NORTH), x + 2, y + 1, z + 1, boundingBox);
					this.addBlock(world, Blocks.WARPED_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.SOUTH), x + 2, y + 1, z - 1, boundingBox);
			}
		...
		@Nullable
		protected StructurePiece method_14874(NetherStrongholdGenerator.Start start, List<StructurePiece> list, Random random, int i, int j) {
			Direction direction = this.getFacing();
			if (direction != null) {
				switch (direction) {
					case NORTH:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.minX + i, this.boundingBox.minY + j, this.boundingBox.minZ - 1, direction, this.getLength());
					case SOUTH:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.minX + i, this.boundingBox.minY + j, this.boundingBox.maxZ + 1, direction, this.getLength());
					case WEST:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.minX - 1, this.boundingBox.minY + j, this.boundingBox.minZ + i, direction, this.getLength());
					case EAST:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY + j, this.boundingBox.minZ + i, direction, this.getLength());
					default:
						return null;
				}
			}
		...
		@Nullable
		protected StructurePiece method_14870(NetherStrongholdGenerator.Start start, List<StructurePiece> list, Random random, int i, int j) {
			Direction direction = this.getFacing();
			if (direction != null) {
				switch (direction) {
					case NORTH:
					case SOUTH:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.minX - 1, this.boundingBox.minY + i, this.boundingBox.minZ + j, Direction.WEST, this.getLength());
					case WEST:
					case EAST:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.minX + j, this.boundingBox.minY + i, this.boundingBox.minZ - 1, Direction.NORTH, this.getLength());
					default:
						return null;
				}
			}
		...
		@Nullable
		protected StructurePiece method_14873(NetherStrongholdGenerator.Start start, List<StructurePiece> list, Random random, int i, int j) {
			Direction direction = this.getFacing();
			if (direction != null) {
				switch (direction) {
					case NORTH:
					case SOUTH:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY + i, this.boundingBox.minZ + j, Direction.EAST, this.getLength());
					case WEST:
					case EAST:
						return NetherStrongholdGenerator.method_14854(start, list, random, this.boundingBox.minX + j, this.boundingBox.minY + i, this.boundingBox.maxZ + 1, Direction.SOUTH, this.getLength());
					default:
						return null;
				}
			}
